...
// Plays a songs that are organized in structs
...
// Function that plays note that is passed as a struct
//
// For example:
//
// struct note d {
//	notenum = 2; 	// notenum "2" corresponds with a D note
//	duration = 3;  	// Look at frequency array for more info
// };
//
// If this struct is passed to playnote a D note will be played
// with a duration of  3 eighths of a second 
