	...
	init();
   	...
   	while (true) {
		...
		if (mapkey(getkey()) == 1) {
			...
			// Time 
			graphics_drawChar(80, 25, 58, 0x0000, 0x7BEF, 3);
			graphics_drawChar(68, 25, 51, 0x0000, 0x7BEF, 3);
			graphics_drawChar(92, 25, 48, 0x0000, 0x7BEF, 3);
			graphics_drawChar(110, 25, 48, 0x000, 0x7BEF, 3);
